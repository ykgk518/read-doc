...
1. [素晴らしいソフトウェアを作り上げる](#素晴らしいソフトウェアを作り上げる)
2. [ソフトウェアの基本構造](#ソフトウェアの基本構造)
3. [品質特性とは](#品質特性とは)
4. [設計のマインドセット](#設計のマインドセット)
5. [戦略を立てる](#戦略を立てる)
6. [設計](#設計)
7. [モデルで複雑さを扱う](#モデルで複雑さを扱う)
8. [パターンの土台を身につける](#パターンの土台を身につける)
9. [データ設計](#データ設計)
10. [インタフェース設計](#インタフェース設計)
    - [外部インタフェース](#外部インタフェース)
    - [内部インタフェース](#内部インタフェース)
11. [設計判断を可視化する](#設計判断を可視化する)
12. [潜在的な解決策を探る](#潜在的な解決策を探る)
13. [SOLIDの原則(WIP)](#solidの原則wip)
